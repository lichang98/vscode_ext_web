...
export function getANNSNNConvertPage(){
  ...
  <body class="dark-mode" style="height: 100%;width: 100%;overflow: auto;">
      ...
      <div class="row" style="margin-top: 30px;">
          <div class="col-md-12">
              <div style="font-size: large;font-weight: bold;text-align: center;margin-left: -160px;">转换参数配置</div>
      ...
      <div class="row" style="height: 100%;width: 100%; margin-top: 50px;white-space: nowrap;">
          <div class="col-md-12" style="overflow-x: auto;">
              <div style="width: 350px;display: inline-block;vertical-align: top;white-space:normal;">
                  <div style="font-size: large;font-weight: bold;text-align: center;margin-left: -20px;">日志输出</div>
                  <div id="log_output_div" style="margin-left: 20px;height: 340px; width: 240px; overflow: auto;margin-top: 60px;">
                  </div>
              </div>
              <div style="width: 460px;display: inline-block;vertical-align: top;">
                  <div style="font-size: large;font-weight: bold;text-align: center;margin-left: -120px;">转换性能分析</div>
                  <div id="use_time_bar_chart" style="width: 340px;height: 400px;margin-top: 15px;margin-left: -10px;"></div>
              </div>
              <div style="height:460px;margin-left: -50px;width: 520px;display: inline-block;vertical-align: top;">
                  <div id="model_layers_vis_tab_caption" style="font-size: large;font-weight: bold;text-align: center;margin-left: -120px;">转换过程信息</div>
                  <table id="info_simu_table" style="margin-left: -40px;margin-right: auto;margin-top: 60px;display: inline-block;border-spacing: 0px 5px; border-collapse: separate;">
                      <tr style="margin-top: 15px;height: 35px;">
                          <td style="width: 80px;font-size: small;font-weight: bold;">转换总耗时</td>
                          <td id="total_use_time">xxx</td>
                      </tr>
                      <tr style="margin-top: 15px;height: 35px;">
                          <td style="font-size: small;font-weight: bold;">平均激发脉冲次数</td>
                          <td id="avg_spike">xxx</td>
                      </tr>
                      <tr style="margin-top: 15px;height: 35px;">
                          <td style="font-size: small;font-weight: bold;">激发脉冲次数方差</td>
                          <td id="std_spike">xxx</td>
                      </tr>
                      <tr style="margin-top: 15px;height: 35px;">
                          <td style="font-size: small;font-weight: bold;">连接权重均值</td>
                          <td id="avg_conn_wt">xxx</td>
                      </tr>
                      <tr style="margin-top: 15px;height: 35px;">
                          <td style="font-size: small;font-weight: bold;">连接权重方差</td>
                          <td id="std_conn_wt">xxx</td>
                      </tr>
                      <tr style="margin-top: 15px;height: 35px;">
                          <td style="font-size: small;font-weight: bold;">ANN转SNN耗时</td>
                          <td id="stage1_time_use">xxx</td>
                      </tr>
                      <tr style="margin-top: 15px;height: 35px;">
                          <td style="font-size: small;font-weight: bold;">预处理耗时</td>
                          <td id="stage2_time_use">xxx</td>
                      </tr>
                      <tr style="margin-top: 15px;height: 35px;">
                          <td style="font-size: small;font-weight: bold;">参数调优耗时</td>
                          <td id="stage3_time_use">xxx</td>
                      </tr>
                      <tr style="margin-top: 15px;height: 35px;">
                          <td style="font-size: small;font-weight: bold;">DarwinLang文件生成耗时</td>
                          <td id="stage4_time_use">xxx</td>
                      </tr>
                  </table>
                  <table id="scale_factors_table" style="margin-right: auto;margin-top: 60px;display: inline-block;vertical-align: top;border-spacing: 0px 5px;border-collapse: separate;">
