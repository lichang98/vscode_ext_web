  ...
  <body class="dark-mode" style="height: 100%;width: 100%;white-space: nowrap;overflow: auto;">
            ...
            <div>
              ...
              <table id="layer_conf_val" style="width: 260px;margin-left:40px;margin-top: 70px;border: solid 3px #D6D6D6;">
                  ...
                  <tr style="height: 25px; border: solid 2px #D6D6D6;color: #333;">
                    <td style="padding-left: 15px;border: solid 2px #D6D6D6;background: #EEEEEE;font-family: SourceHanSansCN-Medium;
                    font-size: 14px;
                    color: #666666;">膜电位阈值</td>
                    <td id="simulate_vthresh" style="text-align: right;padding-right: 15px;"></td>
                  </tr>
                  <tr style="height: 25px;border: solid 2px #D6D6D6;color: #333;"">
                    <td style="padding-left: 15px;border: solid 2px #D6D6D6;background: #EEEEEE;font-family: SourceHanSansCN-Medium;
                    font-size: 14px;
                    color: #666666;">神经元时间步长</td>
                    <td id="simulate_neuron_dt" style="text-align: right;padding-right: 15px;"></td>
                  </tr>
                  <tr style="height: 25px;border: solid 2px #D6D6D6;color: #333;"">
                    <td style="padding-left: 15px;border: solid 2px #D6D6D6;background: #EEEEEE;font-family: SourceHanSansCN-Medium;
                    font-size: 14px;
                    color: #666666;">突触时间步长</td>
                    <td id="simulate_synapse_dt" style="text-align: right;padding-right: 15px;"></td>
                  </tr>
                  <tr style="height: 25px;border: solid 2px #D6D6D6;color: #333;"">
                    <td  style="padding-left: 15px;border: solid 2px #D6D6D6;background: #EEEEEE;font-family: SourceHanSansCN-Medium;
                    font-size: 14px;
                    color: #666666;">延迟</td>
                    <td id="simulate_delay" style="text-align: right;padding-right: 15px;"></td>
                  </tr>
                  <tr style="height: 25px;border: solid 2px #D6D6D6;color: #333;"">
                    <td style="padding-left: 15px;border: solid 2px #D6D6D6;background: #EEEEEE;font-family: SourceHanSansCN-Medium;
                    font-size: 14px;
                    color: #666666;">仿真时长</td>
                    <td id="simulate_dura" style="text-align: right;padding-right: 15px;"></td>
                  </tr>
                  <tr style="height: 25px;border: solid 2px #D6D6D6;color: #333;"">
                    <td style="color: #00BE57;padding-left: 15px;border: solid 2px #D6D6D6;background: #EEEEEE;font-family: SourceHanSansCN-Medium;
                    font-size: 14px;
                    color: #666666;">准确率</td>
                    <td id="simulate_acc" style="color: #00BE57;text-align: right;padding-right: 15px;"></td>
                  </tr>    
              </table>
            </div>
          </div>
          ...
          <div style="background: rgba(238,238,238,0.4);width: 350px;height: 300px;display: inline-block;">
            ...
            <table id="snn_layers_spike_table" style="width: 280px;margin-left:40px;margin-top: 70px;border: solid 3px #D6D6D6;">
              ...
              <tr style="height: 25px; border: solid 2px #D6D6D6;color: #333;">
                ...
                <td style="text-align: center;border: solid 2px #D6D6D6;background: #EEEEEE;font-family: SourceHanSansCN-Medium;
                font-size: 14px;
                color: #666666;">放电次数均值</td>
                <td style="text-align: center;border: solid 2px #D6D6D6;background: #EEEEEE;font-family: SourceHanSansCN-Medium;
                font-size: 14px;
                color: #666666;">放电次数方差</td>
              </tr>
            </table>
          </div>
      ...
      <div style="margin-top: 5px;display: block;">
          ...
          <div style="width: 590px;height: 550px;display: inline-block;margin: left 20px;vertical-align: top;background: rgba(238,238,238,0.4);">
              ...
              <span style="margin-left: 200px;font-family: SourceHanSansCN-Normal;
              font-size: 14px;
              color: #23D951;
